...
BUSINESS_CORE = {
    "2022-23": {
        ...
        "required": [
            ...
            {
                "code": "BSNS 4910",
                "name": "Senior Capstone in Business",
                "credits": 2,
                "also_satisfies": ["WI"],
            },
    ...
    "2025-26": {
        ...
        "required": [
            ...
            {
                "code": "BSNS 1050",
                "name": "Business as a Profession",
                "credits": 3,
            },  # 3 hrs (was 2)
            {"code": "BSNS 2310", "name": "Spreadsheet Analytics", "credits": 3},  # renamed
            {
                "code": "BSNS 2450",
                "name": "Principles of Business Analytics",
                "credits": 3,
            },  # renamed
            {"code": "BSNS 2510", "name": "Business Law", "credits": 3},
            {
            ...
            {"code": "BSNS 4500", "name": "Business Finance", "credits": 3},
            {
                ...
                "credits": 3,  # NEW required
                "also_satisfies": ["Experiential"],
            },
            {
                "code": "BSNS 4910",
                "name": "Senior Seminar in Business & Ethics",
                "credits": 3,
            },  # 3 hrs (was 2); no WI label
            {"code": "ECON 2010", "name": "Macroeconomics", "credits": 3},
            {"code": "ECON 2020", "name": "Microeconomics", "credits": 3},
        ],
