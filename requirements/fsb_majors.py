...
SPORT_MARKETING = {
    ...
    "2025-26": {
        ...
        "major_courses": [
            ...
            {
                "code": "BSNS 4560",
                "name": "Game Day Experience Management",
                "credits": 3,
            },  # renamed; prereq: BSNS 3130 only
...
ACCOUNTING = {
    "2022-23": {
        ...
        "required_courses": [
            ...
            {"code": "ACCT 3110", "name": "Managerial Accounting", "credits": 3},
            {"code": "ACCT 3500", "name": "Accounting Information Systems", "credits": 3},
            {"code": "ACCT 4020", "name": "Federal Income Tax", "credits": 3},
            {"code": "ACCT 4050", "name": "Advanced Federal Income Taxation", "credits": 3},
            {"code": "ACCT 4100", "name": "Advanced Financial Accounting", "credits": 3},
            {"code": "ACCT 4310", "name": "Auditing", "credits": 3},
            {"code": "ACCT 4900", "name": "Professional Ethics for Accountants", "credits": 1},
        ],
        "optional_cma": {
    ...
    "2023-24": {
        ...
        "optional_cma": {"courses": ["BSNS 3240", "BSNS 3350", "BSNS 4150"]},
    },
    "2024-25": {
        "name": "Accounting",
        "total_credits": 68,
