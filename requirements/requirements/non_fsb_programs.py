    ...
    "biochemistry_ba": {
        "2022-23": {
            ...
            "required": [
                ...
                "BIOL 4050",
                "BIOL 4210",
                "BIOL 4220",  # same as CHEM 4210, 4220
                "BIOL 4310",
                "BIOL 4910",
                "BIOL 4920",  # same as CHEM/PHYS 4910, 4920
            ],
            "choose_one_phys": ["PHYS 2140", "PHYS 2240"],
            "choose_one_stats": ["MATH 2120", "PSYC 2440"],
    ...
    "biochemistry_bs": {
        "2022-23": {
            ...
            "required": [
                ...
                "BIOL 4910",
                "BIOL 4920",  # BIOL/CHEM/PHYS 4910/4920
                "MATH 2010",
            ],
            "choose_one_phys": ["PHYS 2140", "PHYS 2240"],
            "choose_one_phys2": ["PHYS 2150", "PHYS 2250"],
...
COMPUTER_SCIENCE = {
    ...
    "cybersecurity_major": {
        ...
        "2025-26": {
            ...
            "professional_core": [
                ...
                "CPSC 3380",
                "CPSC 3410",
                "CPSC 3480",  # NEW: 2150, 3480
                "CPSC 4060",
                "CPSC 4070",
                "CPSC 4080",  # NEW: 4060, 4070
            ],
    ...
    "cybersecurity_minor": {
        "all_years": {
            ...
            "elective": {
                "credits": 7,
                "choose_from": ["CPSC 2300", "CPSC 3380", "CPSC 3410", "CPSC 4080", "CPSC 4480"],
            },
        },
    },
    "data_science_ba": {
    ...
    "comm_minors": {
        ...
        "public_relations_minor": {
            "2025-26": {
                ...
                "elective": {
                    "credits": 9,
                    "choose_from": ["COMM 3050", "COMM 3240", "COMM 3340", "COMM 3370"],
                },
            },
        },
    },
...
HISTORY_POLSCI = {
    "history": {
        "2022-23": {
            "name": "History",
            "total_credits": 36,
            "required": ["HIST 4700"],  # senior capstone
            "elective_upper": {"credits": 27, "dept": "HIST", "min_level": 2000},
            "notes": "At least 18 hrs upper-division; HIST 4700 does not apply to minor",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
        "2025-26": {
            ...
            "required": [
                "HIST 2000",
                "HIST 2300",
                "HIST 2350",  # New foundational courses
...
MUSIC_THEATRE_DANCE = {
    "voice_performance_bmus": {
        "all_years": {
            ...
            "applied_primary": {
                "credits": 22,
                "notes": "Private study in primary area; half + full recital",
            },
    ...
    "musical_theatre_ba": {
        "all_years": {
            ...
            "piano_study": {
                "credits": 2,
                "from": ["MUPF 1050", "MUPF 1060", "MUPF 1710", "MUPF 1720", "MUPF 2030"],
            },
            "mupf_1170": {"credits": 2},
        },
    },
...
CHRISTIAN_MINISTRY = {
    "christian_ministries": {
        "2022-23": {
            ...
            "elective": {
                "credits": 9,
                "notes": "3 hrs from CMIN 3050/3080/3910; 6 hrs from dept offerings",
            },
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
    ...
    "exercise_science": {
        "2022-23": {
            ...
            "core": [
                ...
                "PEHS 3340",
                "PEHS 3410",
                "ATRG 1530",  # becomes EXSC 1530 in 24-25
                "EXSC 2580",
                "ACCT 2010",
                "BSNS 2710",
                "BSNS 2810",
    ...
    "psychology_major": {
        "all_years": {
            ...
            "required": [
                ...
                "SOCI 3210",
                "SOCI 3100",
                "EDUC 2850",  # or PSYC 2850 or SOCI 2850
                "PSYC 4800",  # internship/field
            ],
...
SOCIAL_WORK_CRIMINAL_JUSTICE = {
    ...
    "criminal_justice": {
        "all_years": {
            ...
            "total_credits": "120 total (34 CRIM hrs)",
            "required": [
                "CRIM 2510",
                "CRIM 2520",
                "CRIM 3110",
...
INTERDISCIPLINARY = {
    "peace_conflict_transformation_minor": {
        "2022-23": {
            ...
            "service_learning": {
                "credits": 1,
                "notes": "Cross-cultural, service-learning, or internship",
            },
            "elective": {
                "credits": 9,
                "choose_from": [
        ...
        "2023-24": {
            ...
            "foundation": [
                ...
                "PACT 2200",
                "PACT 2400",
            ],  # Restructured; PACT 2300 removed from required
...
ALL_NON_FSB_PROGRAMS = {
    ...
    "christian_ministries_complementary": CHRISTIAN_MINISTRY_EXTRA[
        "christian_ministries_complementary"
    ],
...
def get_non_fsb_requirements(program_key: str, catalog_year: str):
    ...
    if isinstance(result, dict) and "same_as" in result:
        base = (
            program[result["same_as"]].copy()
            if isinstance(program.get(result["same_as"]), dict)
            else {}
        )
