...
BIOCHEMISTRY = {
    ...
    "biochemistry_bs": {
        "2022-23": {
            ...
            "choose_one": [
                {"name": "Biochemistry I", "credits": 4, "choose_from": ["BIOL-4210", "CHEM-4210"]},
                {"name": "Biochemistry II", "credits": 4, "choose_from": ["BIOL-4220", "CHEM-4220"]},
                {
                    "name": "Science Seminar I",
                    "credits": 1,
                    "choose_from": ["BIOL-4910", "CHEM-4910", "PHYS-4910"],
            ...
            "notes": "BIOL-1000/2230/3800/4700 and CHEM-1000/2700 do not apply toward the major.",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
        "2025-26": {"same_as": "2022-23"},
    ...
    "cs_ba": {
        "2022-23": {
            ...
            "choose_one": [
                ...
                {
                    "name": "Professional Core applied experience",
                    "credits": 3,
                    "choose_from": [
                        "CPSC-4480",
                        "CPSC-4800",
                ...
                },
                {
                    ...
                    "credits": 4,
                    "choose_from": ["MATH-2010", "MATH-2120"],
                },
            ],
    ...
    "cybersecurity_major": {
        "2022-23": {
            ...
            "choose_one": [
                ...
                {
                    "name": "National Security Policy sequence (alt years)",
                    "choose_from": ["POSC-3350", "CRIM-3350"],
                },
                {
                    "name": "Ethics",
                    "choose_from": ["PHIL-3250", "RLGN-3250"],
                },
            ],
            "elective_groups": [
                {
                    ...
                    "notes": "8-9 credits from CPSC 2000+ and approved CRIM/POSC electives",
                },
            ],
        },
        "2023-24": {
    ...
    "exercise_science": {
        "2022-23": {
            ...
            "chemistry_choose": {
                ...
                "label": "Chemistry requirement (CHEM-1000 or CHEM-2110)",
            },
            "concentrations": {
                "Clinical Exercise Physiology": {
                    ...
                    "elective_pool": {
                        ...
                        "notes": "Clinical Exercise Physiology electives",
                    },
                },
                "Pre-Health": {
                    "elective_pool": {
                        ...
                        "notes": "Pre-Health electives",
                    },
                },
                "Sports Performance": {
                    "required": ["ATRG-1530", "EXSC-4010"],
                    "elective_pool": {
                        "credits": 8,
                        "min_courses": 3,
                        "choose_from": [
                        ...
                        "notes": "Sports Performance electives",
                    },
                },
            },
            "notes": "Select one concentration: Clinical Exercise Physiology, Pre-Health, or Sports Performance.",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {
            "name": "Exercise Science",
...
EDUCATION = {
    ...
    "social_studies_teaching": {
        "2022-23": {
            ...
            "choose_one": [
                {
                    "name": "Third Field Intro (Econ/Psych/Soci/SPED)",
                    "credits": 3,
                    "choose_from": ["ECON-2010", "PSYC-2000", "SOCI-2010", "SPED-2400"],
                },
                {
                    "name": "Additional Political Science",
                    "credits": 3,
            ...
            "dist_groups": [
                {
                    "name": "US History upper-division",
                    "credits": 6,
                    "min_courses": 2,
                    "choose_from": ["HIST-3420", "HIST-3440", "HIST-3451", "HIST-3452", "HIST-3470"],
                },
                {
                    "name": "European History foundations",
                    "credits": 3,
                    "min_courses": 1,
                    "choose_from": ["HIST-2030", "HIST-2040"],
                },
                {
                    "name": "European History upper-division",
                    "credits": 3,
                    "min_courses": 1,
                    "choose_from": [
                        "HIST-3010",
                ...
                {
                    "name": "Global History upper-division",
                    "credits": 3,
                    "min_courses": 1,
                    "choose_from": [
                        "HIST-3260",
                ...
                {
                    "name": "Additional 3000-level European or Global History",
                    "credits": 3,
                    "min_courses": 1,
                    "choose_from": [
                        "HIST-3010",
                ...
                {
                    "name": "Third Field advanced electives",
                    "credits": 6,
                    "min_courses": 2,
                    "choose_from": [
                        "ECON-2020",
            ...
            "notes": "Aligned to Social Studies Teaching advising sheet (Rev 8/2022); 51 SSE hours.",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
        "2025-26": {"same_as": "2022-23"},
...
HISTORY_POLS = {
    ...
    "public_history": {
        "2022-23": {
            ...
            "required_capstone": ["HIST-4930", "HIST-4800"],
            "foundational_west_choose": {
                "label": "Foundational history (one from HIST-2030 / HIST-2040)",
                "credits": 3,
                "min_courses": 1,
                "choose_from": ["HIST-2030", "HIST-2040"],
            },
            "foundational_us_choose": {
                "label": "Foundational history (one from HIST-2110 / HIST-2120)",
                "credits": 3,
                "min_courses": 1,
                "choose_from": ["HIST-2110", "HIST-2120"],
            },
            "american_hist_choose": {
                "label": "American History courses (2 courses)",
                "credits": 6,
                "min_courses": 2,
                "choose_from": [
                    "HIST-3420",
            ...
            "european_hist_choose": {
                "label": "European History courses (2 courses)",
                "credits": 6,
                "min_courses": 2,
                "choose_from": ["HIST-3100", "HIST-3135", "HIST-3150", "HIST-3190", "HIST-3220", "HIST-3280"],
            },
            "world_hist_choose": {
                "label": "World History courses (2 courses)",
                "credits": 6,
                "min_courses": 2,
                "choose_from": ["HIST-3240", "HIST-3250", "HIST-3260", "HIST-3300", "HIST-3360", "HIST-3370"],
            },
            "required": [
                "COMM-2240",
                "ARTH-2000",
            ...
            "dist_groups": [
                {
                    "name": "Professional Skills (2 courses)",
                    "credits": 5,
                    "min_courses": 2,
                    "choose_from": ["BSNS-2710", "BSNS-2810", "COMM-3250"],
                },
                {
                    "name": "Media/Communications (1 course)",
                    "credits": 3,
                    "min_courses": 1,
                    "choose_from": ["COMM-3370", "BSNS-4400"],
                },
            ],
            "notes": "Completion of History major requirements (36 hrs) plus Public History core.",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
        "2025-26": {
    ...
    "polsci_philosophy_economics": {
        "2022-23": {
            "name": "Political Science, Philosophy, and Economics",
            "total_credits": 54,
            "required": [
                "POSC-2020",
                "POSC-2100",
            ...
            "choose_one": [
                ...
                {
                    "name": "Ethics and Morality for Professionals",
                    "choose_from": ["PHIL-3250", "RLGN-3250"],
                },
            ],
            "elective_groups": [
                {
                    "name": "Upper-division POSC/PHIL/ECON electives",
                    "credits": 12,
                    "min_courses": 4,
                    "choose_from": [
                        "POSC-3000",
                    ...
                    "notes": "No more than 3 credits total from POSC-4800/4810/4820",
                },
            ],
        },
        "2023-24": {"same_as": "2022-23"},
...
SOCIAL_SCIENCES = {
    "psychology": {
        "2022-23": {
            ...
            "dist_groups": [
                {
                    "name": "PSYC upper-division core list (min 12 hrs)",
                    "credits": 12,
                    "min_courses": 3,
                    "choose_from": [
                        "PSYC-3010",
                ...
                {
                    "name": "PSYC remaining elective hours",
                    "credits": 8,
                    "min_courses": 2,
                    "choose_from": [
                        "PSYC-2100",
...
SPORT_REC = {
    "sport_recreational_leadership": {
        "2022-23": {
            ...
            "notes": "EXSC-2140 is strongly encouraged for Scientific Ways; MATH-1300 or MATH-1400 is strongly encouraged for Quantitative Reasoning and ACCT-2010 readiness.",
        },
        "2023-24": {"same_as": "2022-23"},
        "2024-25": {"same_as": "2022-23"},
    },
